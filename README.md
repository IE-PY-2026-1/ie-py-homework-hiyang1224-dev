...
<br>
[작업 내역 기록]: 카테고리 선택 후 파일 수와 문항 수 입력 (복합 계산 및 누적)
[현재 누적 포인트 확인]: 실시간으로 합산된 총 포인트 및 항목별 수량 조회
[단가 및 기준표 보기]: 파일/문항당 설정된 카테고리별 포인트 기준 확인
[세후 예상 급여 계산]: 현재 총 포인트 기준 3.3% 공제 후 실수령액 계산
[이번 달 기록 초기화]: 정산 완료 후 새 달을 위한 데이터 리셋
[종료]: 데이터 저장 및 매니저 프로그램 종료
